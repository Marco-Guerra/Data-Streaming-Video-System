...
string readStdioUserVideosIdentifications();

// função que faz a leitura da saída estandar o tamanho do histórico de vídeos de um usuário
int readStdioUserHistoryLenght();
